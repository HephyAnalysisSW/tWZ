...
python EFT_UL.py --reduceEFT --threePoint --selection=trilepT-minDLmass12-onZ1-btag0-vetoMET60 --era=ULRunII
python EFT_UL.py --reduceEFT --threePoint --selection=trilepFOnoT-minDLmass12-onZ1-btag0-vetoMET60 --era=ULRunII --applyFakerate --useDataSF
python EFT_UL.py --reduceEFT --threePoint --selection=trilepFOnoT-minDLmass12-onZ1-btag0-vetoMET60 --era=ULRunII --applyFakerate --useDataSF --sys=Fakerate_UP
python EFT_UL.py --reduceEFT --threePoint --selection=trilepFOnoT-minDLmass12-onZ1-btag0-vetoMET60 --era=ULRunII --applyFakerate --useDataSF --sys=Fakerate_DOWN
