...
cmd_harvester = "CreateCards_FakerateClosure "+args.year
...
for r in range(nRegions):
    region = r+1
    cardname = "FakerateClosure_%s_%s_13TeV_%s.txt"%(args.year,str(region),args.year)
    cmd_regions += cardname+" "
cmd_regions += "> FakerateClosure_%s_combined_13TeV_%s.txt"%(args.year,args.year)
