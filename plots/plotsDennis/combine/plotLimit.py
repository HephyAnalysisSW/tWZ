...
if likelihoods.has_key('combined') and likelihoods.has_key('ttZ') and likelihoods.has_key('ZZ') and likelihoods.has_key('WZ'):
    ...
    leg = ROOT.TLegend(.5, .6, .85, .85)
    leg.AddEntry(likelihoods["combined"], "All regions", "l")
    leg.AddEntry(likelihoods["ttZ"], "ttZ region", "l")
    leg.AddEntry(likelihoods["ZZ"], "ZZ region", "l")
    leg.AddEntry(likelihoods["WZ"], "WZ region", "l")
    leg.Draw()
