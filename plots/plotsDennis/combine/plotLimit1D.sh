...
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re1122 --addStatOnly --light --NjetSplit
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re33   --addStatOnly --light --NjetSplit
...
#
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re1122 --light --signalInjectionHeavy
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re33   --light --signalInjectionHeavy
#
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re1122 --light --signalInjectionMixed
# python plotLimit1D.py --year=ULRunII --wc=cHq1Re33   --light --signalInjectionMixed
