# python plotLimit2D.py --year=ULRunII --wc=cHq1Re1122-cHq1Re33 --light --NjetSplit
# python plotLimit2D.py --year=ULRunII --wc=cHq3Re1122-cHq3Re33 --light --NjetSplit

# python plotLimit2D.py --year=ULRunII --wc=cHq1Re1122-cHq1Re33 --light --onlyCombined
# python plotLimit2D.py --year=ULRunII --wc=cHq3Re1122-cHq3Re33 --light --onlyCombined
