...
fname = "DataCards_FakerateClosure/"+args.year+"/fitDiagnostics.FakerateClosure_ULRunII_REGION_13TeV_"+args.year+"_SHAPES.root"
print fname

regions = {
    "WZ":       ["FakerateClosure_ULRunII_1_13TeV"],
    "ttZ":      ["FakerateClosure_ULRunII_2_13TeV"],
    "combined": ["ch1", "ch2"],
}

plotdir = plot_directory+"/PostFit_FakerateClosure/"+args.year+"/"
if not os.path.exists( plotdir ): os.makedirs( plotdir )

dataHists = {
    "WZ": getObjFromFile("/groups/hephy/cms/dennis.schwarz/www/tWZ/CombineInput_UL_FakerateClosure/"+args.year+"/CombineInput.root", "WZ__Z1_pt/data_obs"),
    "ttZ": getObjFromFile("/groups/hephy/cms/dennis.schwarz/www/tWZ/CombineInput_UL_FakerateClosure/"+args.year+"/CombineInput.root", "ttZ__Z1_pt/data_obs"),
}
...
for region in ["ttZ", "WZ", "combined"]:
    for dir in regions[region]:
        ...
        for process in processinfo.keys():
            hist = getHist(filename, "shapes_fit_s/"+dir+"/"+process)
