...
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re1122 --signalInjectionLight --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re33   --signalInjectionLight --fluctuatePseudoData
#
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re1122 --signalInjectionHeavy --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re33   --signalInjectionHeavy --fluctuatePseudoData
#
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re1122 --signalInjectionMixed --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re33   --signalInjectionMixed --fluctuatePseudoData
#
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re1122 --signalInjectionWZjets --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq1Re33   --signalInjectionWZjets --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq3Re1122 --signalInjectionWZjets --fluctuatePseudoData
# python runCombine_threePoint.py --year=ULRunII --light --impacts --region=combined --oneD=cHq3Re33   --signalInjectionWZjets --fluctuatePseudoData
