...
fileDir = "/scratch-cbe/users/dennis.schwarz/tWZ/nanoTuples/"+version+"/"+args.year+"/singlelep/"
...
for (sampleName, i, nJobs) in missing:
    writeline = "python nanoPostProcessing_UL.py  --overwrite --forceProxy --skim singlelep --triggerSelection --year "+args.year+" --processingEra "+version+" --sample "+sampleName
    if nJobs != 1:
