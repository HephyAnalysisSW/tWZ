...
version = "tWZ_UL_nAODv9_triggerSF_v1"

fileDir = "/scratch-cbe/users/dennis.schwarz/tWZ/nanoTuples/"+version+"/"+args.year+"/trilep/"
submitFileName = "/users/dennis.schwarz/CMSSW_10_6_28/src/tWZ/postProcessing/nanoPostProcessing_"+shortyear+"_nanoAODv9_triggerSF.sh"
...
missingfilesname = "missingFiles_triggerSF_"+shortyear+".sh"
f = open(missingfilesname, "w")
for (sampleName, i, nJobs) in missing:
    writeline = "python nanoPostProcessing_UL.py  --overwrite --forceProxy --triggerSF --skim trilep --year "+args.year+" --processingEra "+version+" --sample "+sampleName
    if nJobs != 1:
