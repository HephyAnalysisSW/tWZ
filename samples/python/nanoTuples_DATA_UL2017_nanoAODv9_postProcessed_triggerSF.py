...
try:
    ...
    directory_ = locations.data_triggerSF_UL2017
...
allSamples += [JetHT_Run2017, MET_Run2017]

Run2017 = Sample.combine("Run2017", [MET_Run2017, JetHT_Run2017], texName = "Run2017")
