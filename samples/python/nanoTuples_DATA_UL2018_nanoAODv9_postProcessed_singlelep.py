...
try:
    ...
    directory_ = locations.data_singlelep_UL2018
...
allSamples += [EGamma_Run2018, SingleMuon_Run2018]

Run2018 = Sample.combine("Run2018", [EGamma_Run2018, SingleMuon_Run2018], texName = "Run2018")
